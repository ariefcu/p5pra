<x-layout>
    ...
    <div class="py-8 mx-auto max-w-screen-xl lg:px-6">
            ...
            <form>
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        ...
                        <input class="block p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:rounded-none sm:rounded-l-lg focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="search" type="search" id="search" name="cari" autocomplete="off">
                    </div>
                    <div>
        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            @empty
                <div>
                    ...
                    <a href="/posts" class="block text-blue-600 hover:underline">&laquo; Bact to all posts</a>
                </div>
            @endforelse
        </div>
    </div>
